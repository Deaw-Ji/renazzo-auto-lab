...
export const FIRESTORE_DB_ID = 'ai-studio-renazzoautolab-63911943-8222-4a99-99f5-67bdf9e55f99';
export const db = getFirestore(app, FIRESTORE_DB_ID);

export const testFirestoreConnection = async () => {
  try {
    await getDocFromServer(doc(db, 'records', '_test_connection'));
  } catch (error) {
...
// Cache the access token in memory (MANDATORY: never store in localStorage/sessionStorage)
